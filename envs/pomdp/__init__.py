...
#register(
    ...
    #entry_point="envs.pomdp.wrappers:POMDPWrapper",
    #kwargs=dict(
        #env=gym.make("LunarLander-v3"), partially_obs_dims=list(range(8))
    #),  # angle & velocity
...
#register(
    #"LunarLander-P-v0",
    #entry_point="envs.pomdp.wrappers:POMDPWrapper",
    #kwargs=dict(env=gym.make("LunarLander-v3"), partially_obs_dims=[0, 1, 4, 6, 7]),
...
#register(
    #"LunarLander-V-v0",
    #entry_point="envs.pomdp.wrappers:POMDPWrapper",
    #kwargs=dict(env=gym.make("LunarLander-v3"), partially_obs_dims=[2, 3, 5, 6, 7]),
    #max_episode_steps=1000,
#)
